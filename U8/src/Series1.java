public class Series1 {
    ...
    public Series1(String titulo, String autor) {
        this(titulo, 3, false, "", autor);
    }

    // Constructor con todos los atributos excepto 'completado'
    public Series1(String titulo, int numTemporadas, String genero, String autor) {
        this(titulo, numTemporadas, false, genero, autor);
    }

    // Constructor con todos los atributos
    public Series1(String titulo, int numTemporadas, boolean completado, String genero, String autor) {
        this.titulo = titulo;
